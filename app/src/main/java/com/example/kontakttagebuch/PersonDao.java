...
public interface PersonDao {
    ...
    @Query("SELECT * FROM person ORDER BY firstName ASC LIMIT 5")
    LiveData<List<Person>> getTop5AlphabetizedPersons();

    @Query("SELECT pid,firstName,lastName FROM person ORDER BY firstName ASC")
